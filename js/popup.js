const tour = new Shepherd.Tour({
  ...
  tour.addStep({
    text: `The right panel of each visualization displays detailed information corresponding to selections in the visualization such as collection highlights and events. 
    In the network view, the right panel contains a list of all the events; scrolling through them alters the networks according to the visible events.`,
    attachTo: {
      element: '#sidebar',
    },
    buttons: [
